 ...
 * @author hhern
 */
public class MecanicaBasica extends Especialidades implements Interfaces {

    String especialidad = "Mecanica Basica";
    Vehiculos v = new Vehiculos();

    private static ArrayList<MecanicaBasica> mecBasica = new ArrayList();

    public MecanicaBasica() {
    }

    public MecanicaBasica(String especialidad, String nombreCliente, String Placa, String nombreMec, String subEspec, int valorRep) {
        super(nombreCliente, Placa, nombreMec, subEspec, valorRep);
        this.especialidad = especialidad;
    }

    public static ArrayList<MecanicaBasica> getMecBasica() {
        return mecBasica;
    }

    public static void setMecBasica(ArrayList<MecanicaBasica> mecBasica) {
        MecanicaBasica.mecBasica = mecBasica;
    }
    ...
    public void agregar() {
        ...
        for (int e = 0; e < Mecanicos.getMecBasica().size(); e++) {
            mecanicos = mecanicos + Mecanicos.getMecBasica().get(e).getNombre() + "\n";
            String mecNom = JOptionPane.showInputDialog(mecanicos + "Digite el nombre del mecanico a agregar:");
            if (mecNom.equalsIgnoreCase(Mecanicos.getMecBasica().get(e).getNombre())) {
                nombreMec = Mecanicos.getMecBasica().get(e).getNombre();
            } else {
                JOptionPane.showMessageDialog(null, "No se encuentra el valor");
            }
        }
        subs();
        MecanicaBasica NewCli = new MecanicaBasica(especialidad, nombreCliente, Placa, nombreMec, subEspec, valorRep);
        mecBasica.add(NewCli);
    ...
    public void subs() {
        int opcion;
        do {
            String[] opciones = {"Cambio de aceite y filtros", "Cambio de bujias", "Cambio de llantas", "Revision de frenos", "Revision de luces", "Salir"};
            ...
            switch (opcion) {
                case 0:
                    String[] opciones1 = {"Motor", "Caja", "Hidraulico", "Salir"};
                    int opcion1 = JOptionPane.showOptionDialog(null, "Seleccion de tipo de aceite", "Seleccionar", 0, JOptionPane.QUESTION_MESSAGE, null, opciones1, "Motor");
                    switch (opcion1) {
                        case 0:
                            subEspec = "Cambio de aceite y filtros: Motor";
                            valorRep = 35000;
                            v.incrementarContador();
                            JOptionPane.showMessageDialog(null, "Servicio agregado correctamente.");
                            break;
                        case 1:
                            subEspec = "Cambio de aceite y filtros: Caja de cambios";
                            valorRep = 25000;
                            v.incrementarContador();
                            JOptionPane.showMessageDialog(null, "Servicio agregado correctamente.");
                            break;
                        case 2:
                            subEspec = "Cambio de aceite y filtros: Caja de direccion";
                            valorRep = 20000;
                            v.incrementarContador();
                            JOptionPane.showMessageDialog(null, "Servicio agregado correctamente.");
                            break;
                    ...
                    break;
                case 1:
                    subEspec = "Cambio de bujias";
                    valorRep = 40000;
                    v.incrementarContador();
                    JOptionPane.showMessageDialog(null, "Servicio agregado correctamente.");
                    break;
                case 2:
                    String[] opciones2 = {"Llantas nuevas", "Balanceo", "Tramado", "Salir"};
                    int opcion2 = JOptionPane.showOptionDialog(null, "Seleccion de servicio de llantas", "Seleccionar", 0, JOptionPane.QUESTION_MESSAGE, null, opciones2, "Motor");
                    switch (opcion2) {
                        case 0:
                            subEspec = "Cambio de Llantas: Llantas nuevas";
                            valorRep = 230000;
                            v.incrementarContador();
                            JOptionPane.showMessageDialog(null, "Servicio agregado correctamente.");
                            break;
                        case 1:
                            subEspec = "Cambio de Llantas: Balanceo";
                            valorRep = 23000;
                            v.incrementarContador();
                            JOptionPane.showMessageDialog(null, "Servicio agregado correctamente.");
                            break;
                        case 2:
                            subEspec = "Cambio de Llantas: Tramado";
                            valorRep = 23000;
                            v.incrementarContador();
                            JOptionPane.showMessageDialog(null, "Servicio agregado correctamente.");
                            break;
                    ...
                    break;
                case 3:
                    subEspec = "Revision de frenos";
                    valorRep = 46000;
                    v.incrementarContador();
                    JOptionPane.showMessageDialog(null, "Servicio agregado correctamente.");
                    break;
                case 4:
                    subEspec = "Revision de luces";
                    valorRep = 50000;
                    v.incrementarContador();
                    JOptionPane.showMessageDialog(null, "Servicio agregado correctamente.");
                    break;
        ...
        switch (editar) {
            case 0:
                for (int i = 0; i < mecBasica.size(); i++) {
                    JOptionPane.showMessageDialog(null, "Nombre del cliente: " + mecBasica.get(i).getNombreCliente() + "\n" + "Placa: " + mecBasica.get(i).getPlaca() + "\n" + "Nombre del mecanico: " + mecBasica.get(i).getNombreMec() + "\n" + "Especialidad: " + mecBasica.get(i).getEspecialidad() + "\n" + "Sub Especialidad: " + mecBasica.get(i).getSubEspec() + "\n" + "Valor de reparacion: " + mecBasica.get(i).getValorRep() + "\n");
                }
                break;
            case 1:
                String info1 = "";
                for (int i = 0; i < mecBasica.size(); i++) {
                    info1 = info1 + ("Nombre del cliente: " + mecBasica.get(i).getNombreCliente() + "\n" + "Placa: " + mecBasica.get(i).getPlaca() + "\n" + "Nombre del mecanico: " + mecBasica.get(i).getNombreMec() + "\n" + "Especialidad: " + mecBasica.get(i).getEspecialidad() + "\n" + "Sub Especialidad: " + mecBasica.get(i).getSubEspec() + "\n" + "Valor de reparacion: " + mecBasica.get(i).getValorRep() + "\n");
                }
    ...
    public void modificar() {
        ...
        for (int i = 0; i < mecBasica.size(); i++) {
            if (buscarPlaca.equalsIgnoreCase(mecBasica.get(i).getPlaca())) {
                ...
                switch (editar) {
                    case 0:
                        ...
                        if (busqueda.equalsIgnoreCase(mecBasica.get(i).getNombreCliente())) {
                            mecBasica.get(i).setNombreCliente(nuevoNom);
                        } else {
                    ...
                    case 1:
                        ...
                        if (busqueda1.equalsIgnoreCase(mecBasica.get(i).getPlaca())) {
                            mecBasica.get(i).setPlaca(nuevoPla);
                        } else {
                            JOptionPane.showMessageDialog(null, "No se encuentra en valor indicado");
                        }
                        break;
                    case 2:
                        ...
                        if (busqueda2.equalsIgnoreCase(mecBasica.get(i).getNombreMec())) {
                            mecBasica.get(i).setNombreMec(nuevoMec);
                        } else {
                            JOptionPane.showMessageDialog(null, "No se encuentra en valor indicado");
                        }
                        break;
                    case 3:
                        ...
                        if (busqueda3.equalsIgnoreCase(mecBasica.get(i).getSubEspec())) {
                            mecBasica.get(i).setSubEspec(nuevosub);
                        } else {
                            JOptionPane.showMessageDialog(null, "No se encuentra en valor indicado");
                        }
                        break;
                    case 4:
                        ...
                        if (busqueda4 == mecBasica.get(i).getValorRep()) {
                            mecBasica.get(i).setValorRep(nuevorep);
                        } else {
                            JOptionPane.showMessageDialog(null, "No se encuentra en valor indicado");
                        }
                        break;
    ...
    public void eliminar() {
        ...
        for (int i = 0; i < mecBasica.size(); i++) {
            if (placabus.equalsIgnoreCase(mecBasica.get(i).getPlaca())) {
                mecBasica.remove(i);
    ...
    double montoTotal = 0;
    for (int i = 0; i < mecBasica.size(); i++) {
        MecanicaBasica servicio = mecBasica.get(i);
