 ...
 * @author hhern
 */
public class MecanicaElectricos extends Especialidades implements Interfaces{
    
    String especialidad="Mecanica de automotores electricos";
    Vehiculos v = new Vehiculos();
    
    private static ArrayList<MecanicaElectricos> mecElectricos = new ArrayList();

    public MecanicaElectricos() {
    }

    public MecanicaElectricos(String especialidad, String nombreCliente, String Placa, String nombreMec, String subEspec, int valorRep) {
    ...
    public static ArrayList<MecanicaElectricos> getMecElectricos() {
        return mecElectricos;
    }

    public static void setMecElectricos(ArrayList<MecanicaElectricos> mecElectricos) {
        MecanicaElectricos.mecElectricos = mecElectricos;
    }
    ...
    public void agregar() {
        ...
        for (int e = 0; e < Mecanicos.getMecElectricos().size(); e++) {
            mecanicos = mecanicos + Mecanicos.getMecElectricos().get(e).getNombre() + "\n";
            String mecNom = JOptionPane.showInputDialog(mecanicos + "Digite el nombre del mecanico a agregar:");
            if (mecNom.equalsIgnoreCase(Mecanicos.getMecElectricos().get(e).getNombre())) {
                nombreMec = Mecanicos.getMecElectricos().get(e).getNombre();
            } else {
                JOptionPane.showMessageDialog(null, "No se encuentra el valor");
            }
        }
        subs();
        MecanicaElectricos NewCli = new MecanicaElectricos(especialidad, nombreCliente, Placa, nombreMec, subEspec, valorRep);
        mecElectricos.add(NewCli);
        ...
        switch (editar) {
            case 0:
                for (int i = 0; i < mecElectricos.size(); i++) {
                    JOptionPane.showMessageDialog(null, "Nombre del cliente: " + mecElectricos.get(i).getNombreCliente() + "\n" + "Placa: " + mecElectricos.get(i).getPlaca() + "\n" + "Nombre del mecanico: " + mecElectricos.get(i).getNombreMec() + "\n" +"Especialidad: " + mecElectricos.get(i).getEspecialidad() + "\n"+ "Sub Especialidad: " + mecElectricos.get(i).getSubEspec() + "\n" + "Valor de reparacion: " + mecElectricos.get(i).getValorRep() + "\n");
                }
                break;
            case 1:
                String info1 = "";
                for (int i = 0; i < mecElectricos.size(); i++) {
                    info1 = info1 + ( "Nombre del cliente: " + mecElectricos.get(i).getNombreCliente() + "\n" + "Placa: " + mecElectricos.get(i).getPlaca() + "\n" + "Nombre del mecanico: " + mecElectricos.get(i).getNombreMec() + "\n" +"Especialidad: "+mecElectricos.get(i).getEspecialidad()+"\n"+ "Sub Especialidad: " + mecElectricos.get(i).getSubEspec() + "\n" + "Valor de reparacion: " + mecElectricos.get(i).getValorRep() + "\n");
                }
    ...
    public void modificar() {
        ...
        for (int i = 0; i < mecElectricos.size(); i++) {
            if (buscarPlaca.equalsIgnoreCase(mecElectricos.get(i).getPlaca())) {
                ...
                switch (editar) {
                    case 0:
                        ...
                        if (busqueda.equalsIgnoreCase(mecElectricos.get(i).getNombreCliente())) {
                            mecElectricos.get(i).setNombreCliente(nuevoNom);
                        } else {
                    ...
                    case 1:
                        ...
                        if (busqueda1.equalsIgnoreCase(mecElectricos.get(i).getPlaca())) {
                            mecElectricos.get(i).setPlaca(nuevoPla);
                        } else {
                            JOptionPane.showMessageDialog(null, "No se encuentra en valor indicado");
                        }
                        break;
                    case 2:
                        ...
                        if (busqueda2.equalsIgnoreCase(mecElectricos.get(i).getNombreMec())) {
                            mecElectricos.get(i).setNombreMec(nuevoMec);
                        } else {
                            JOptionPane.showMessageDialog(null, "No se encuentra en valor indicado");
                        }
                        break;
                    case 3:
                        ...
                        if (busqueda3.equalsIgnoreCase(mecElectricos.get(i).getSubEspec())) {
                            mecElectricos.get(i).setSubEspec(nuevosub);
                        } else {
                            JOptionPane.showMessageDialog(null, "No se encuentra en valor indicado");
                        }
                        break;
                    case 4:
                        ...
                        if (busqueda4 == mecElectricos.get(i).getValorRep()) {
                            mecElectricos.get(i).setValorRep(nuevorep);
                        } else {
                            JOptionPane.showMessageDialog(null, "No se encuentra en valor indicado");
                        }
                        break;
    ...
    public void eliminar() {
        ...
        for (int i = 0; i < mecElectricos.size(); i++) {
            if (placabus.equalsIgnoreCase(mecElectricos.get(i).getPlaca())) {
    ...
    public void subs(){
        int opcion;
        do {
            String[] opciones = {"Sistema electrico y auxiliares","Bateria","Revision de frenos","Cambio de roles", "Salir"};
            ...
            switch (opcion) {
                case 0:
                    subEspec="Sistema electrico y auxiliares";
                    valorRep=40000;
...
public double calcularMontoTotal() {
    double montoTotal = 0;
    for (int i = 0; i < mecElectricos.size(); i++) {
        MecanicaElectricos servicio = mecElectricos.get(i);
