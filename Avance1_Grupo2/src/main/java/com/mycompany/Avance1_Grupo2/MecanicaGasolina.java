 ...
 * @author hhern
 */
public class MecanicaGasolina extends Especialidades implements Interfaces{
    
    String especialidad="Mecanica de automotores gasolina";
    Vehiculos v = new Vehiculos();
    
    private static ArrayList<MecanicaGasolina> mecGasolina = new ArrayList();

    public MecanicaGasolina() {
    }

    public MecanicaGasolina(String especialidad, String nombreCliente, String Placa, String nombreMec, String subEspec, int valorRep) {
    ...
    public static ArrayList<MecanicaGasolina> getMecGasolina() {
        return mecGasolina;
    }

    public static void setMecGasolina(ArrayList<MecanicaGasolina> mecGasolina) {
        MecanicaGasolina.mecGasolina = mecGasolina;
    }
    ...
    public void agregar() {
        ...
        for (int e = 0; e < Mecanicos.getMecGasolina().size(); e++) {
            mecanicos = mecanicos + Mecanicos.getMecGasolina().get(e).getNombre() + "\n";
            String mecNom = JOptionPane.showInputDialog(mecanicos + "Digite el nombre del mecanico a agregar:");
            if (mecNom.equalsIgnoreCase(Mecanicos.getMecGasolina().get(e).getNombre())) {
                nombreMec = Mecanicos.getMecGasolina().get(e).getNombre();
            } else {
                JOptionPane.showMessageDialog(null, "No se encuentra el valor");
            }
        }
        subs();
        MecanicaGasolina NewCli = new MecanicaGasolina(especialidad, nombreCliente, Placa, nombreMec, subEspec, valorRep);
        mecGasolina.add(NewCli);
        ...
        switch (editar) {
            case 0:
                for (int i = 0; i < mecGasolina.size(); i++) {
                    JOptionPane.showMessageDialog(null, "Nombre del cliente: " + mecGasolina.get(i).getNombreCliente() + "\n" + "Placa: " + mecGasolina.get(i).getPlaca() + "\n" + "Nombre del mecanico: " + mecGasolina.get(i).getNombreMec() + "\n" +"Especialidad: " + mecGasolina.get(i).getEspecialidad() + "\n"+ "Sub Especialidad: " + mecGasolina.get(i).getSubEspec() + "\n" + "Valor de reparacion: " + mecGasolina.get(i).getValorRep() + "\n");
                }
                break;
            case 1:
                String info1 = "";
                for (int i = 0; i < mecGasolina.size(); i++) {
                    info1 = info1 + ( "Nombre del cliente: " + mecGasolina.get(i).getNombreCliente() + "\n" + "Placa: " + mecGasolina.get(i).getPlaca() + "\n" + "Nombre del mecanico: " + mecGasolina.get(i).getNombreMec() + "\n" +"Especialidad: "+mecGasolina.get(i).getEspecialidad()+"\n"+ "Sub Especialidad: " + mecGasolina.get(i).getSubEspec() + "\n" + "Valor de reparacion: " + mecGasolina.get(i).getValorRep() + "\n");
                }
    ...
    public void modificar() {
        ...
        for (int i = 0; i < mecGasolina.size(); i++) {
            if (buscarPlaca.equalsIgnoreCase(mecGasolina.get(i).getPlaca())) {
                ...
                switch (editar) {
                    case 0:
                        ...
                        if (busqueda.equalsIgnoreCase(mecGasolina.get(i).getNombreCliente())) {
                            mecGasolina.get(i).setNombreCliente(nuevoNom);
                        } else {
                    ...
                    case 1:
                        ...
                        if (busqueda1.equalsIgnoreCase(mecGasolina.get(i).getPlaca())) {
                            mecGasolina.get(i).setPlaca(nuevoPla);
                        } else {
                            JOptionPane.showMessageDialog(null, "No se encuentra en valor indicado");
                        }
                        break;
                    case 2:
                        ...
                        if (busqueda2.equalsIgnoreCase(mecGasolina.get(i).getNombreMec())) {
                            mecGasolina.get(i).setNombreMec(nuevoMec);
                        } else {
                            JOptionPane.showMessageDialog(null, "No se encuentra en valor indicado");
                        }
                        break;
                    case 3:
                        ...
                        if (busqueda3.equalsIgnoreCase(mecGasolina.get(i).getSubEspec())) {
                            mecGasolina.get(i).setSubEspec(nuevosub);
                        } else {
                            JOptionPane.showMessageDialog(null, "No se encuentra en valor indicado");
                        }
                        break;
                    case 4:
                        ...
                        if (busqueda4 == mecGasolina.get(i).getValorRep()) {
                            mecGasolina.get(i).setValorRep(nuevorep);
                        } else {
                            JOptionPane.showMessageDialog(null, "No se encuentra en valor indicado");
                        }
                        break;
    ...
    public void eliminar() {
        ...
        for (int i = 0; i < mecGasolina.size(); i++) {
            if (placabus.equalsIgnoreCase(mecGasolina.get(i).getPlaca())) {
    ...
    public void menuGas() {
        ...
        int opcion;
        do {
            String[] opciones = {"Revision de motor", "Tune up", "Desgaste mecanico", "Sistemas electricos","Cambio de roles","Cambio de caja de cambios", "Salir"};
            ...
            switch (opcion) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    subEspec="Cambio de roles";
                    valorRep=50000;
                    v.incrementarContador();
                    JOptionPane.showMessageDialog(null, "Servicio agregado correctamente.");
                    break;
                case 5:
                    String[] opciones2 = {"Caja manual","Caja automatica","Salir"};
                    ...
                    switch (opcion2) {
                        case 0:
                            subEspec="Cambio de caja de cambios: Manual";
                            valorRep=100000;
                            v.incrementarContador();
                            JOptionPane.showMessageDialog(null, "Servicio agregado correctamente.");
                            break;
                        case 1:
                            subEspec="Cambio de caja de cambios: Automatica";
                            valorRep=100000;
                            v.incrementarContador();
                            JOptionPane.showMessageDialog(null, "Servicio agregado correctamente.");
                            break;
...
public double calcularMontoTotal() {
    double montoTotal = 0;
    for (int i = 0; i < mecGasolina.size(); i++) {
        MecanicaGasolina servicio = mecGasolina.get(i);
